...
def license:
    label_id = 1234567890
    print(label_id)
    label_name = "Preetham Thippana"
    print(label_name)
    label_dob = "January 1 2000"
    print(label_dob)
    label_pin="123454321"
    print(label_pin)
    label_address = "Milky Way, Earth"
    print(label_address)
    label_vehicle_type="Four Wheeler"
    print(label_vehicle_type)
    
    
button2=(root, command=license)
